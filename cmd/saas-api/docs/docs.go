...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_MuhamadAgungGumelar_micro-system-ai-agent-be_internal_modules_saas_services.AddToCartRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_MuhamadAgungGumelar_micro-system-ai-agent-be_internal_modules_saas_services.RemoveFromCartRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_MuhamadAgungGumelar_micro-system-ai-agent-be_internal_modules_saas_services.UpdateCartItemRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_MuhamadAgungGumelar_micro-system-ai-agent-be_internal_modules_saas_services.UpdateOrderRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_MuhamadAgungGumelar_micro-system-ai-agent-be_internal_modules_saas_models.OrderItem": {
            "type": "object",
            "properties": {
                "notes": {
                    "type": "string"
        ...
        "github_com_MuhamadAgungGumelar_micro-system-ai-agent-be_internal_modules_saas_services.AddToCartRequest": {
            "type": "object",
            "properties": {
                "client_id": {
                    "type": "string"
        ...
        "github_com_MuhamadAgungGumelar_micro-system-ai-agent-be_internal_modules_saas_services.RemoveFromCartRequest": {
            "type": "object",
            "properties": {
                "product_id": {
                    "type": "string"
        ...
        "github_com_MuhamadAgungGumelar_micro-system-ai-agent-be_internal_modules_saas_services.UpdateCartItemRequest": {
            "type": "object",
            "properties": {
                "product_id": {
                    "type": "string"
        ...
        "github_com_MuhamadAgungGumelar_micro-system-ai-agent-be_internal_modules_saas_services.UpdateOrderRequest": {
            "type": "object",
            "properties": {
                "admin_notes": {
                    "type": "string"
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_MuhamadAgungGumelar_micro-system-ai-agent-be_internal_modules_saas_models.OrderItem"
                    }
                },
                "total_amount": {
                    "type": "number"
